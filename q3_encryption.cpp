...
class RSA{
    ...
    vector<int64> generateKey(){
        ...
        int64 rand = getRandomNumber(0,5);
...
{
    string M ;
    cout << newl << "Enter the message " << newl << newl;
    getline(cin,M);
    ...
    cout << "Generating RSA Key pair..." << newl << newl;
    ...
    cout << newl << "Digital Signature is " << newl;
    cout << newl << sig << newl;
    cout << newl;
    ...
    cout << "Message in Hex, padded to multiple of 64 bit is" << newl;
    cout << newl << M_hex << newl;
    cout << newl;
    ...
    sleep(1);
    cout << "Message + signature in Hex, padded to multiple of 64 bit is" << newl;
    cout << newl << plain_text << newl;
    cout << newl;


    DES_Encryption des;
    string key;
    cout << newl << "Enter key in hexadecimal of 16 characters for DES Encryption " << newl;
    cin >> key;
    ...
    sleep(1);
	cout << "Succesfully written cipher text to file " << file << newl << newl;
    cout << "Succesfully written DES key to file " << file << newl << newl;
    cout << "Succesfully written RSA key pair to file " << file << newl << newl;

	freopen((file).c_str(), "w", stdout);
	cout << cipher_text << newl;
	cout << key << newl;
	cout << e << newl << d << newl << n;
